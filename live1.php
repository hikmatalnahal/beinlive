...
<body>
    <div class="container-fluid aos-all" id="transcroller-body" >
        ...
        <h1>مشاهدة مباراة مانشستر يونايتد ضد استون فيلا عبر بين لايف</h1>
        <span>beinlive</span>
      <section class="container-fluid">
<p><iframe allowfullscreen='true' frameborder='0' height='500px' scrolling='1' src='https://koora.live-kooora.com/albaplayer/bein-premium-2hd/' width='100%'>beinlive</iframe></p>
      </section>
     		<!-- Optional JavaScript -->
