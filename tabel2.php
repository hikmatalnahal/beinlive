          ...
          if (mysqli_num_rows($result)>0){
              while ($row=mysqli_fetch_assoc($result)){
                  ...
                  echo "<tr>".
                      ...
                      "<td>".$row['stats']."</td>".
                      "<td>
                          <a href='edite.php?id=".$row['id'] ."' class='btn btn-outline-primary  box-shadow-3 mr-1 mb-1'>EDIT</a>
                      </td>".

                      "<td>
                          <form class='c_form' action='delet.php' method='post'>
